					...
					<%@include file="navbar.jsp" %>
						...
						<div class="container-fluid">
							<div class="row px-xl-5">
										...
										<tbody class="align-middle">
											...
											<c:forEach var="item" items="${cart.items}">
												<form action="/cart/update/${item.id}" method="post">
													...
													<tr>
														<td class="align-middle"><img src="/upload/${item.image}" alt=""
																style="width: 50px;"> <a
														...
														<td class="align-middle">
															<div class="input-group quantity mx-auto"
																...
																<div class="input-group-btn">
																	<button
																		class="btn btn-sm btn-warning text-white btn-minus">
																...
																<div class="input-group-btn">
																	<button
																		class="btn btn-sm btn-warning text-white btn-plus">
								...
								<div class="col-lg-4">
									<form class="mb-30" action="/shop/addvoucher" method="post">
							...
							<h6 class="font-weight-medium">30.000 VNĐ</h6>
										...
										<div class="pt-2">
											...
											<a href="/shop/checkout"
												class="btn btn-block btn-warning text-white font-weight-bold my-3 py-3">Tiến
												Hành Đặt Hàng</a>
										</div>
									</div>
								</div>
						...
						<%@include file="footer.jsp" %>
							...
							<!-- Back to Top -->
							<a href="#" class="btn btn-warning text-white back-to-top"><i
