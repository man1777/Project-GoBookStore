								...
								<table align="center" border="0" cellpadding="0" cellspacing="0" width="100%"
									...
									<tr>
										<td align="center" valign="top" style="font-size: 0; padding: 35px;"
											...
											<divstyle="display: inline-block; max-width: 50%; min-width: 100px;
												vertical-align: top; width: 100%;" class="mobile-hide">
												<table align="left" border="0" cellpadding="0" cellspacing="0"
													width="100%" style="max-width: 300px;">
													<tr>
											...
											<table align="center" border="0" cellpadding="0" cellspacing="0"
												...
												<tr>
													<td align="center"
														...
														<img src="https://emax.thoitrang360.vn/wp-content/uploads/2021/06/icon-dat-hang-thanh-cong-09.jpg"
															width="120" height="90"
														...
														<h2
															...
															Cảm ơn vì đã mua hàng bên <b
																style="color: orange;">BookStore</b></h2>
													</td>
												</tr>
												<tr>
													<td align="left"
														...
														<p
															...
															Vui lòng kiểm tra thông tin đơn hàng. Nếu có bất kỳ câu hỏi
															nào vui lòng liện hệ số điện thoại <b>1992456321</b> để được
															hỗ trợ. Xin cảm ơn !
														</p>
													</td>
												</tr>
																...
																<tr>
																	...
																	<td width="25%" align="right"
																		...
																		<fmt:formatNumber type="number"
																			pattern="###,###,###"
																			value="${item.product.price * item.quality}" />
																		VNĐ
																	</td>
																</tr>
															</c:forEach>
															...
															<table align="left" border="0" cellpadding="0"
																...
																<tr>
																	<td align="left" valign="top"
																		...
																		<p style="font-weight: 800;">Địa chỉ giao hàng
																		</p>
																		<p>
																			${address}
																		</p>
														...
														<div
															...
															<table align="left" border="0" cellpadding="0"
																...
																<tr>
																	<td align="right" valign="top"
																		style="font-family: Open Sans, Helvetica, Arial, sans-serif; font-size: 16px; font-weight: 400; line-height: 24px;">
																		<p style="font-weight: 800;">Thời gian nhận được
																			hàng</p>
																		<p>4-5 ngày.</p>
																	</td>
																</tr>
														...
														<table border="0" cellspacing="0" cellpadding="0">
															<tr>
																<td align="center" style="border-radius: 5px;"
																	bgcolor="#66b3b7"><a href="/index"
																		style="font-size: 18px; font-family: Open Sans, Helvetica, Arial, sans-serif; color: #ffffff; text-decoration: none; border-radius: 5px; background-color: #F44336; padding: 15px 30px; border: 1px solid #F44336; display: block;">Trở
																		lại <i class="fas fa-hand-point-left"></i></a>
																</td>
															</tr>
														</table>
													</td>
												...
												<tr>
													<td align="center"
														...
														<p
															...
															778/B1 Nguyen Kiem, <br> P.4, Q. Phu Nhuan, <br>Ho Chi Minh
															city
														</p>
													</td>
												</tr>
