						...
						<div class="card-body p-0">
							...
							<div class="row">
								<div class="col-lg-5 d-none d-lg-block">
									<img style="margin-top:40px" width="500"
										src="https://img.freepik.com/free-vector/sign-up-concept-illustration_114360-7875.jpg?w=740&t=st=1706248531~exp=1706249131~hmac=64cc5b6d0155e39c5fc077b79ba55aa9971a367e263fceedfa70f6e717ac10de"
										alt="IMG">
								</div>
								<div class="col-lg-7">
									<div class="p-5">
										<div class="text-center">
											<h1 class="h4 text-gray-900 mb-4" style="font-family: 'Roboto';">Đăng Ký
											</h1>
										</div>
										<form:form action="/register/check" modelAttribute="userRegister" method="post"
											class="user">
                                            ...
                                            Vui lòng nhập mã xác thực!
													...
													<form:errors path="code" cssClass="invalid-feedback text-center" />
												</div>
											</div>
                                    ...
                                    <div class="input-group-append">
                                        <button class="btn btn-outline-secondary" type="button"
                                            id="exampleInputEmail">Button</button>
												...
												<form:errors path="email" cssClass="invalid-feedback text-center" />
											</div>
											...
											<div class="form-group row">
												<div class="col-sm-6 mb-3 mb-sm-0">
													<form:password path="password" value="${userRegister.password}"
														cssClass="form-control form-control-user"
														cssErrorClass="form-control form-control-user is-invalid"
