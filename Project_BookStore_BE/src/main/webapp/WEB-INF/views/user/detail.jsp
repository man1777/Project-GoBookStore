							...
							<div class="row px-xl-5">
									...
									<div id="product-carousel" class="carousel slide" data-ride="carousel">
										<div class="carousel-inner bg-light">
											<div class="carousel-item active">
												<img class="w-100 h-100" src="/upload/${loadInfo.image}" alt="Image">
											</div>
                              ...
                              <div class="carousel-item">
                                   <img class="w-100 h-100" src="img/product-4.jpg" alt="Image">
										...
										<a class="carousel-control-prev" href="#product-carousel" data-slide="prev"> <i
								...
								<div class="col-lg-7 h-auto mb-30">
									<div class="h-100 bg-light p-30">
										...
										<div class="d-flex mb-3">
											<div class="text-warning mr-2">
												...
												<small class="fas fa-star"></small> <small
													class="fas fa-star-half-alt"></small> <small
										...
										<p>Sách hay lắm mua đi mọi người, để cùng nhau có thêm :
											<br> + Kiến thức
											<br> + Kinh nghiệm
											<br> + Trải nghiệm
										</p>
										<form action="/shop/detail/${sessionScope.manufacture}" method="post">
											<div class="d-flex align-items-center mb-4 pt-2">
												<div class="input-group quantity mr-3" style="width: 130px;">
													<div class="input-group-btn">
														<button type="button"
															class="btn btn-warning text-white btn-minus">
													...
													<div class="input-group-btn">
														<button type="button"
															class="btn btn-warning text-white btn-plus">
												...
												<a href="/shop/favorite/${loadInfo.id}"
													class="btn btn-danger px-3 ml-3 ${checkFavorite?'':'disabled'}"><i
									...
									<div class="bg-light p-30">
										<div class="nav nav-tabs mb-4">
											<a class="nav-item nav-link text-dark active" data-toggle="tab"
												href="#tab-pane-1">Mô tả</a> <a class="nav-item nav-link text-dark"
														...
														<div class="media mb-4">
															...
															<div class="media-body">
																...
																<p>Diam amet duo labore stet elitr ea clita ipsum,
																	tempor
																	labore accusam ipsum et no at. Kasd diam tempor
																	rebum magna
												...
												<div class="text-center py-4">
													...
													<div class="d-flex align-items-center justify-content-center mb-1">
														<small class="fa fa-star text-warning mr-1"></small> <small
															...
															class="fa fa-star text-warning mr-1"></small> <small
															class="fa fa-star text-warning mr-1"></small> <small
															class="fa fa-star text-warning mr-1"></small>
														<small>(99)</small>
													</div>
												</div>
											</div>
