									...
									<div class="col-md-3">
										<div class="nav flex-column nav-pills" role="tablist"
											...
											<a class="nav-link active" id="orders-nav" data-toggle="pill"
												...
												class="nav-link" id="account-nav" data-toggle="pill" href="#account-tab"
												onclick="location.href='/shop/profile/user';" role="tab"><i
													class="fa fa-user"></i>Thông Tin Cá Nhân</a> <a class="nav-link"
												href="/logout"><i class="fa fa-sign-out-alt"></i>Đăng
												Xuất</a>
										</div>
									</div>
									<div class="col-md-9">
