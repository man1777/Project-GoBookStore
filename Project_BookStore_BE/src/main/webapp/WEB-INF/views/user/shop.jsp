								...
								<div class="bg-light p-4 mb-30">
									<form>
										<div
											...
											<label class="custom-control-label" for="size-all">All Size</label> <span
												class="badge border font-weight-normal"></span>
										</div>
										...
										<c:forEach var="item" items="${size}">
											<div
												...
												<label class="custom-control-label"
													for="color-1">${item.group.name}</label>
												<span class="badge border font-weight-normal">${item.count}</span>
											</div>
										</c:forEach>
										...
										<div class="d-flex align-items-center justify-content-right mb-4">
											<div class="ml-2">
												...
												<div class="btn-group ml-2">
													...
													<div class="dropdown-menu dropdown-menu-right">
														<a class="dropdown-item" href="#">9</a> <a class="dropdown-item"
															href="#">12</a> <a class="dropdown-item" href="#">15</a>
													</div>
												</div>
											</div>
										</div>
										...
										<nav>
											<ul class="pagination justify-content-center">
												<li class="page-item ${(shop.number==0)?'disabled':''}"><a
														class="page-link"
														href="/shop/category/${sessionScope.cateId}?p=${shop.number-1}">Trước</span></a>
												</li>
												<li class="page-item disabled"><a class="page-link">${shop.number+1}</a>
												</li>
												<li class="page-item ${(shop.number>=shop.totalPages-1)?'disabled':''}">
													<a class="page-link"
														href="/shop/category/${sessionScope.cateId}?p=${shop.number+1}">Sau</a>
												</li>
											</ul>
										</nav>
									</div>
